package com.fantasy.rabbitdada.service.impl;
...
import com.fantasy.rabbitdada.constant.CommonConstant;
import com.fantasy.rabbitdada.exception.ThrowUtils;
import com.fantasy.rabbitdada.mapper.ScoringResultMapper;
import com.fantasy.rabbitdada.model.dto.scoringResult.ScoringResultQueryRequest;
import com.fantasy.rabbitdada.model.entity.App;
import com.fantasy.rabbitdada.model.entity.ScoringResult;
import com.fantasy.rabbitdada.model.entity.User;
import com.fantasy.rabbitdada.model.vo.ScoringResultVO;
import com.fantasy.rabbitdada.model.vo.UserVO;
import com.fantasy.rabbitdada.service.AppService;
import com.fantasy.rabbitdada.service.ScoringResultService;
import com.fantasy.rabbitdada.service.UserService;
import com.fantasy.rabbitdada.utils.SqlUtils;
...
public class ScoringResultServiceImpl extends ServiceImpl<ScoringResultMapper, ScoringResult> implements ScoringResultService {
    ...
    public void validScoringResult(ScoringResult scoringResult, boolean add) {
        ...
        if (add) {
            ...
            ThrowUtils.throwIf(resultScoreRange == null || resultScoreRange <= 0, ErrorCode.PARAMS_ERROR, "结果分数范围不能为空");
    ...
    public QueryWrapper<ScoringResult> getQueryWrapper(ScoringResultQueryRequest scoringResultQueryRequest) {
        ...
        // 模糊查询
        queryWrapper.like(StringUtils.isNotEmpty(resultName), "resultName", resultName);
